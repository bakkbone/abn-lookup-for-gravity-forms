    ...
    class ITSG_GF_AbnLookup_Fields {
		...
		public static function abnlookup_field_settings( $position, $form_id ) {
			if ( 25 == $position ) {
				...
				<li class="abnlookup_entity_results_field_setting field_setting" style="display: list-item; background: rgb(244, 244, 244) none repeat scroll 0px 0px; padding-top: 10px; padding-right: 10px; padding-left: 10px; margin: 10px 0px -10px;" >
