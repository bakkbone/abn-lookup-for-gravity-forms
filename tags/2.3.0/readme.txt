...
Yes. Its entire purpose is to link you with the [ABN Lookup service](https://abr.business.gov.au/Tools/WebServices) provided by the Australian Government.
...
== Changelog ==
### 2.3.0
* DEV: Repair API access by fixing nonce verification
### 2.2.1
* DEV: Add nonce check to ajax call
...
### 2.1.1
* DEV: Fix `sprintf()` causing fatal error
### 2.1.0
* DEV: Fix bug where JS was not firing on Ajax forms
* TWEAK: Improve responsiveness of search field upon data entry
### 2.0.1
* TWEAK: Fix JS error when only one business name returned
### 2.0.0
...
* TWEAK: Improve plugin localization.
### 1.8.0
...
== Upgrade Notice ==
### 2.0.0
Upgrades to 2020 API and adds Business Names feature
### 1.9.0
